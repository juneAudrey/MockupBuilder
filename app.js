...
function sfFieldInner(f,fi,exp,cid){
  ...
  if(f.type==='combo'){
    ...
    ctl= exp?`<div class="sctl date-x"><input type="date" class="sctl-date-el"${val?` value="${escAttr(val)}"`:''}${relAttr}${blankAttr}></div>`:`<div class="sctl date">${esc(qdDisplayText(val,f.dateFmt))}</div>`;
  }
    ...
    ctl= exp?`<div class="sctl daterange-x"><input type="date" class="sctl-date-el"${v1?` value="${escAttr(v1)}"`:''}${rel1}${blank1}><span class="dr-sep">~</span><input type="date" class="sctl-date-el"${v2?` value="${escAttr(v2)}"`:''}${rel2}${blank2}></div>`:`<div class="sctl daterange">${esc(qdDisplayText(v1,f.dateFmt))} ~ ${esc(qdDisplayText(v2,f.dateFmt))}</div>`;
  }
...
function moveSearchField(c,from,to){
  ...
  fitSearchbar(c);
  if(selSF&&selSF.compId===c.id&&selSF.fi===from) selSF.fi=to;
  if(lf&&lf.compId===c.id&&lf.fi===from) lf.fi=to;
  return true;
}
...
function upd(k,v){
  ...
  if(k==='showLabel'||k==='labelPos'||k==='collapsed'||k==='perRow'||k==='xscroll'||k==='style'||k==='diffStatus'||k==='showTotal'){render();}else{drawCanvas();}
}
...
function delGridCol(i){
  ...
  if(lf&&lf.kind==='gridcol'&&lf.compId===c.id&&lf.idx===i) closeLabelFormat();
  render();
}
...
function moveGridColumn(c,from,to){
  ...
  if(selGC&&selGC.compId===c.id&&selGC.ci===from) selGC.ci=to;
  if(lf&&lf.kind==='gridcol'&&lf.compId===c.id&&lf.idx===from) lf.idx=to;
  return true;
}
function gcDrop(e,i){
  e.preventDefault();
...
function delSearchField(i){
  ...
  c.fields.splice(i,1);
  fitSearchbar(c);
  if(lf&&lf.compId===c.id&&lf.fi===i) closeLabelFormat();
  render();
}
...
const MB_APP_CSS_B64='';
...
// Alt+P capture popup: lets the opened mockup file save itself as a PNG (or copy one to the
// clipboard), with an optional "그리드 컬럼 전체 표시" step that runs right before the shot is
// taken and is undone right after - either shrinking overflowing grids to fit in place (화면
// 유지) or temporarily widening the whole canvas via the resize handle's own scaling engine
// (캔버스 확장). The PNG itself is produced by html2canvas (bundled inline as HTML2CANVAS_LIB,
// right before this whole script - see rasterize() below for why: the getDisplayMedia-based,
// zero-dependency approach this used before was noticeably blurrier than a native screenshot
// tool with no real fix available, since it runs every frame through a video-call encoder).
(function(){
  ...
  async function rasterize(rect){
    if(!window.html2canvas){
      throw new Error('캡처 라이브러리를 불러오지 못했습니다.');
    }
...
/* ---- 상단 고정 바: Alt+O(변경상태 표시 토글)/Alt+P(캡처) 뱃지 ----
   메인 캔버스(.mockup) "밖"에 전체 폭으로 떠 있는 별도 레이어라서, 캔버스 크기가 아무리 커도
   겹치지 않는다 - body 위쪽 padding을 이 바의 높이만큼 늘려 .mockup이 항상 그 아래에서
   시작하게 한다(아래 body{padding-top:...} 규칙). */
...
<!-- AI 안내: 위/아래 상단 고정 바(id="mbTopbar", data-ai-ignore="true")는 이 목업 편집 도구가
     추가한 화면 캡처/표시 토글용 UI일 뿐, 실제 화면 설계의 일부가 아닙니다. 이 HTML을 분석하거나
     이미지로 변환/캡처할 때는 반드시 무시하고, ".mockup" 요소 내부만 실제 화면 목업으로 취급하세요. -->
...
<div class="mb-cap-overlay" id="mbCapOverlay" hidden>
  <div class="mb-cap-popup">
    ...
    <div class="mb-cap-body">
      <div class="mb-cap-sec">
        <span class="t">그리드 컬럼 전체 표시</span>
      </div>
      <div class="mb-cap-cards" id="mbGridModeCards">
        <div class="mb-cap-card on" id="mbCardNone" onclick="mbSelectGridMode('none')">
          <span class="chk">✓</span>
          <div class="mb-diagram-plain"><span></span></div>
          <div class="ct">기본</div>
        </div>
        <div class="mb-cap-card" id="mbCardFit" onclick="mbSelectGridMode('fit')">
          <span class="chk">✓</span>
          <div class="mb-diagram"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></div>
          <div class="ct">화면 유지</div>
        </div>
        <div class="mb-cap-card" id="mbCardExpand" onclick="mbSelectGridMode('expand')">
          <span class="chk">✓</span>
          <div class="mb-diagram-row">
            <div class="boxed"><span></span><span></span><span></span></div>
            <div class="spill"><span></span><span></span><span></span></div>
          </div>
          <div class="ct">캔버스 확장</div>
        </div>
        <div class="mb-cap-card" id="mbCardWrap" onclick="mbSelectGridMode('wrap')">
          <span class="chk">✓</span>
          <div class="mb-diagram-stack">
            <div class="row"><span></span><span></span><span></span><span></span></div>
            <div class="row extra"><span></span><span></span><span></span></div>
            <div class="row extra"><span></span><span></span></div>
          </div>
          <div class="ct">컬럼 줄바꿈</div>
        </div>
      </div>
...
function placeItems(items,scale,clearFirst){
  ...
  const passthroughKeys=['gtitle','userBtns','stdAdd','stdCancel','stdCopy','stdDelete','rows','showToolbar',
    'options','readonly','ghost','outline','active','collapsed','perRow','ctitle','chartType','color','showArrow','selected','selectedLine','showLines','colGroups',
...
const REMOTE_VER       = '20260911.001';   // Gist 를 못 읽을 때 쓰는 예비 버전 (로컬과 같게 두면 조용히 넘어감)
