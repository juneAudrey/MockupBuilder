...
const PATCH_NOTES=[
  {ver:'20260919.001', date:'2026년 9월 19일', items:[
    {t:'📊 사양서 매핑 템플릿 내보내기 (Alt+S)', d:'① 결과물 상단 바에 <b>Alt+S</b> 뱃지 추가 - 클릭하면 화면 구성을 정리한 <b>엑셀 파일(.xlsx)</b>을 바로 내려받습니다.<br>② 화면 제목·캡처 이미지·구성 요약과 함께, 조회조건·입력항목·그리드 컬럼별로 <b>표시타입·필수·읽기전용</b>을 자동으로 채워 넣습니다.<br>③ 사양서 작성 시 화면 구성을 다시 옮겨 적을 필요 없이 그대로 참고할 수 있습니다.<br>④ 이 기능만 인터넷 연결이 필요합니다(엑셀 생성 라이브러리를 그때그때 불러옴) - 오프라인이어도 나머지 기능은 그대로 작동합니다.'}
  ]},
